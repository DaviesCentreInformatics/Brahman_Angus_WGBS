...
ctrl.file.list <- list('./BxA/F13.Consensus.CpGs.methylKit.gz',
...
makeMethylDB(meth, dbdir='./BAvsBB.consensus.base/')

meth <- readMethylDB('./BAvsBB.consensus.base/methylBase_min5_destrand.txt.bgz')
